...
@section('contents')
    <div class="baggageinfoContainer">
        <div>
            <h2>수하물 안내</h2>
            <h5>수하물 관련 규정을 확인하세요.</h5>
        </div>
        <div>
            <div>휴대 수하물</div>
            <ul>
                <li>고객이 기내로 가져갈 수 있는 수하물을 말합니다.</li>
                <li>
                    10 kg 이하 1개에 한함
                    <br>
                    (세변의 합이 115 cm 이하, 각 변의 최대치는 가로 40 cm, 세로 20 cm, 높이 55 cm미만)
                </li>
                <li>추가 허용 품목 : 노트북 컴퓨터, 서류가방, 핸드백 중 1개</li>
                <li>기내 휴대 수하물 허용 기준을 초과(무게, 사이즈 또는 개수)하는 모든 수하물은 반드시 수속카운터에서 미리 부치시기 바랍니다. 탑승구에서 위탁 시 별도 수수료가 부과됩니다.</li>
                <li>
                ...
                <li>단, 기내 휴대 수하물 허용 규격에 부합하는 경우 기내 반입은 가능하나, 기내 탑재공간 부족시 탑승구에서 위탁될수 있으니 이점 양지하시기 바랍니다.</li>
            </ul>
            <div>무료 위탁 수하물</div>
            <ul>
                <li>고객이 출발지 공항에서 항공사에 탁송 의뢰하여 목적지 공항에서 수취하는 수하물을 말합니다.</li>
                <li>안전한 수하물 위탁을 위해 가방(짐)은 항공사에서 안내하는 지정된 크기와 무게를 지켜 준비하여 주시기 바랍니다.</li>
                <li>위탁 수하물 1개의 크기가 203cm(가로 X 세로 X 높이의 합)를 초과할 경우 위탁 수하물로서의 운송이 거절될 수 있습니다.</li>
                <li>위탁 수하물 1개의 무게는 32kg을 초과할 수 없으며, 초과 시에는 분리하여 포장해 주셔야 합니다.</li>
            </ul>
        </div>
        <table class="bbsList">
            <thead>
