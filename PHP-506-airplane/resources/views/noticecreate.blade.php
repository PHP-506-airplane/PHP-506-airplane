...
<div class="nCreateContainer">
    ...
    <form action="{{route('notice.store')}}" method="POST" class="formCreate" enctype="multipart/form-data" onsubmit="updateContentTextarea()">
        @csrf
        ...
        <div contentEditable="true" class="divContent" id="divContent">
